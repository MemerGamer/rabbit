...
typedef enum RabbitContentType{
    ...
    // VND (Application)
    RBT_CT_VND_OASIS_OPENDOC_TXT,
    RBT_CT_VND_OASIS_OPENDOC_SPREADSHEET,
    RBT_CT_VND_OASIS_OPENDOC_PRESENTATION,
    RBT_CT_VND_OASIS_OPENDOC_GRAPHICS,
    RBT_CT_VND_MS_EXCEL,
    RBT_CT_VND_OPENXMLFORMATS_OFFICEDOC_SPREDSHEETML_SHEET,
    RBT_CT_VND_MS_POWERPOINT,
    RBT_CT_VND_OPENXMLFORMATS_OFFICEDOC_PRESENTATION,
    RBT_CT_VND_MSWORD,
    RBT_CT_VND_OPENXMLFORMATS_OFFICEDOC_WORDPROCESSINGML_DOCUMENT,
    RBT_CT_VND_MOZZILLA_XUL_XML,
